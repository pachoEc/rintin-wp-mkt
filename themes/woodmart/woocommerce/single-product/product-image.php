...
$attachment_ids              = $product !== null && $product->get_gallery_image_ids();
$post_thumbnail_id           = $product !== null && $product->get_image_id();
...
$wrapper_classes = apply_filters(
	...
	array(
		...
		'woocommerce-product-gallery--' . ( $product !== null && $product->get_image_id() ? 'with-images' : 'without-images' ),
...
<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?> images row image-action-<?php echo esc_attr( $image_action ); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
	...
	<div class="<?php echo esc_attr( $main_gallery_classes ); ?>">
		...
		<figure class="woocommerce-product-gallery__wrapper<?php echo esc_attr( $gallery_classes ); ?>" <?php echo wp_kses( implode( ' ', $main_gallery_attrs ), true ); ?>>
			...
			if ( $product !== null && $product->get_image_id() ) {
