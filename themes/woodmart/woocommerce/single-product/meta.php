...
<div class="product_meta<?php echo esc_attr( $wrapper_classes ); ?>">
	...
	<?php if ( $show_sku && wc_product_sku_enabled() && ( $product !== null && $product->get_sku() || $product !== null && $product->is_type( 'variable' ) ) ) : ?>
	...
	<?php if ( $show_categories ) : ?>
		<?php echo wc_get_product_category_list( $product !== null && $product->get_id(), '<span class="meta-sep">,</span> ', '<span class="posted_in"><span class="meta-label">' . _n( 'Category:', 'Categories:', count( $product !== null && $product->get_category_ids() ), 'woocommerce' ) . '</span> ', '</span>' ); // phpcs:ignore ?>
	<?php endif; ?>

	<?php if ( $show_tags ) : ?>
		<?php echo wc_get_product_tag_list( $product !== null && $product->get_id(), '<span class="meta-sep">,</span> ', '<span class="tagged_as"><span class="meta-label">' . _n( 'Tag:', 'Tags:', count( $product !== null && $product->get_tag_ids() ), 'woocommerce' ) . '</span> ', '</span>' ); // phpcs:ignore ?>
	<?php endif; ?>
